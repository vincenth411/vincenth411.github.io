...
function hasHitWall() {
  // ROWS: 20 // the total number of ROWS in the board (20)
  //COLUMNS:20// the total number of COLUMNS in the board (20)
...
function hasCollidedWithSnake() {
  for (var i = 1; i < snake.body.length; i++) {
    var snakesquare = snake.body[i];
    if (snake.head.row === snakesquare.row && snake.head.column === snakesquare.column) return true;
  }
  /* 
...
function makeApple() {
  ...
  // get a random available row/column on the board
  var randomPosition = getRandomAvailablePosition(2);
